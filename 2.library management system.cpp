...
{ 
    ...
    do{ 
        cout<<"1.Accept\t2.sort in descending order\t3.cost less than 500rs\t4.duplicate 
entries using temp array\t5.duplicate entries without temp array\t6.Books more than 
500rs\t7.display\t8.Unsorted array\t9.Exit\nEnter choice:"; 
        cin>>ch; 
        switch(ch) 
        { 
            case 1://info() 
