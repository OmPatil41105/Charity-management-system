...
public: 
    ...
    void addTrack(string title, string artist, string album, string genre, int duration, int 
releaseYear) { 
    ...
    void updateTrack(string title, string newArtist, string newAlbum, string newGenre, int 
newDuration, int newReleaseYear) { 
        if (head == nullptr) { 
            cout << "No tracks in the music library.\n"; 
            return; 
        } 
